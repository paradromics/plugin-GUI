...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//Processor name
		info->dataThread.name = "NIOB"; //Processor name shown in the GUI
		...
		info->dataThread.type = ProcessorType::FilterProcessor;
